...
import { protect, admin } from '../auth/authModule';
import { getUsers, createUser, deleteUser, importUsers, exportUsers, getSystemStats, adminResetUserPassword } from './adminController';
import { getAIConfig, updateAIConfig, getSystemDefaults, updateSystemDefaults } from './systemConfigController';
...
router.route('/config/defaults')
    .get(protect, admin, getSystemDefaults)
    .put(protect, admin, updateSystemDefaults);
